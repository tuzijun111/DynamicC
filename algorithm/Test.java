...
public class Test {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        abc = DataPro.CsvData("/Users/binbingu/Documents/Datasets/amazon-samples/amazon1K.csv", 1);
        //abc = DataPro.CsvData("/Users/binbingu/Documents/Datasets/3D_Road/3D_spatial_network.txt.csv", 0);
//        for (int i=0; i<20; i++)
//            System.out.println(abc.get(i));

//
//        int []array ={1};   //specify the attributes used to evaluate the distance; this is for Amazon Access
...
//        Evaluate.Count(adj);
        ...
        ArrayList<ArrayList<Integer>> cluster = Cluster.static_DBSCAN(0, adj.size(), adj);
...
//        cluster = DSframe.Dy_DBSCAN(cluster, ttt, adj);
//        //cluster = Cluster.dynamic_DBSCAN(cluster, ttt, adj);
//        for (int s = 0 ; s < cluster.size(); s++)
//            System.out.println(cluster.get(s));
//        System.out.println(AdjMatrix.k_means_score(cluster, abc));
